...
const notificationFormSchema = z.object({
  examCreation: z.boolean(),
  studentRegistration: z.boolean(),
  resultSubmission: z.boolean(),
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex flex-col items-center">
                ...
                <Badge className="mt-2 bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-400">Admin</Badge>
                ...
                <div className="w-full mt-6 pt-6 border-t border-border">
                  <h3 className="text-sm font-medium mb-3">Admin Activity</h3>
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="bg-green-100 dark:bg-green-900/30 rounded p-3 text-center">
                      <p className="text-lg font-medium text-green-700 dark:text-green-400">156</p>
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <Input placeholder="Exam Administrator" {...field} />
                              </FormControl>
                              <FormMessage />
                            </FormItem>
                          )}
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input placeholder="Professional summary" {...field} />
                            </FormControl>
                            <FormDescription>
                              A brief description about your professional background
                            </FormDescription>
                            <FormMessage />
                          </FormItem>
                        )}
                    ...
                    <form onSubmit={notificationForm.handleSubmit(onNotificationSubmit)} className="space-y-6">
                        ...
                        render={({ field }) => (
                          <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                            <div className="space-y-0.5">
                              <FormLabel className="text-base">Exam Creation</FormLabel>
                              <FormDescription>
                                Receive notifications when new exams are created or modified
                              </FormDescription>
                            </div>
                            <FormControl>
                              <Switch
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                            <div className="space-y-0.5">
                              <FormLabel className="text-base">Student Registration</FormLabel>
                              <FormDescription>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                            <div className="space-y-0.5">
                              <FormLabel className="text-base">Result Submission</FormLabel>
                              <FormDescription>
                                Receive notifications when exam results are submitted
                              </FormDescription>
                            </div>
                            <FormControl>
                              <Switch
                        ...
                        render={({ field }) => (
                          <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                            <div className="space-y-0.5">
                              ...
                              <FormDescription>
                                Receive notifications when students provide feedback
                              </FormDescription>
                            </div>
                            <FormControl>
                              <Switch

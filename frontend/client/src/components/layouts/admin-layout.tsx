...
export default function AdminLayout({ children }: AdminLayoutProps) {
  ...
  const navigation = [
    ...
    { name: "Exams", href: "/admin/exams", icon: ClipboardList, current: location === "/admin/exams" },
    { name: "Questions", href: "/admin/questions", icon: HelpCircle, current: location === "/admin/questions" },
    { name: "Students", href: "/admin/students", icon: Users, current: location === "/admin/students" },
    { name: "Results", href: "/admin/results", icon: BarChart, current: location === "/admin/results" },
    { name: "Feedback", href: "/admin/feedback", icon: MessageSquare, current: location === "/admin/feedback" },
    { name: "Logs", href: "/admin/logs", icon: History, current: location === "/admin/logs" },
  ];
          ...
          <div className="px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between h-16">
              ...
              <div className="flex items-center">
                <SearchBar placeholder="Search exams, students..." onSearch={handleSearch} />
